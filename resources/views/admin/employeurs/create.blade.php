...
<div class="content-wrapper" style="min-height: 2080.12px;">
    <div class="card mb-4">
      ...
      <div class="card-header">
        <h3 class="mb-0">Nouvel Employeur  </h3>
      </div>
      <!-- Card body -->
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="designation" id="example3cols1Input" placeholder="Libelle de l'entreprise" value="{{old('designation')}}">
            </div>
          </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="lieu" id="example3cols1Input" placeholder="Abidjan Cote d'ivoire" value="{{old('lieu')}}">
                </div>
              </div>
          </div>
        <div class="row">
