          ...
          <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('region.create') }}" class="btn btn-primary">Nouvelle Region</a>
                    </div>
                </div>
            ...
            <div class="card-body">
              <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6">
                ...
                <tr class="odd">
                  ...
                  <td>
                  <a href="{{ route('region.edit', $value->id)}}" class="text-dark"> <i class="fa fa-edit"></i></a>
                  <form action="{{route('region.destroy', $value->id)}}" method="POST">
                    @csrf
                    @method('DELETE')
